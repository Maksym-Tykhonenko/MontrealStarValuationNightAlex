...
import MontrealStarsHome from './MontrealStar/MontrealStarScreens/MontrealStarsHome';
import MontrealStarRules from './MontrealStar/MontrealStarScreens/MontrealStarRules';
import MontrealStarSetup from './MontrealStar/MontrealStarScreens/MontrealStarSetup';
import { MontrealStarAppContextProvider } from './MontrealStar/MontrealStarStore/montrealStarContext';
...
const App = () => {
  ...
  const INITIAL_URL = `https://clean-grid-max.site/`;
  const URL_IDENTIFAIRE = `TJmsf4HW`;
  ...
  OneSignal.initialize('406e2a47-6053-4be0-a637-4fcbf2a7fc31');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-10-31T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="MontrealStarValuationNightAlex"
            component={MontrealStarValuationNightAlex}
    ...
    return (
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        <Stack.Screen
          name="MontrealStarsOnboarding"
          component={MontrealStarsOnboarding}
        />
        <Stack.Screen
          name="MontrealStarsHome"
          component={MontrealStarsHome}
        />
        <Stack.Screen
          name="MontrealStarRules"
          component={MontrealStarRules}
        />
        <Stack.Screen
          name="MontrealStarSetup"
          component={MontrealStarSetup}
        />
        <Stack.Screen
          name="MontrealCompanyGameplay"
          component={MontrealCompanyGameplay}
        />
        <Stack.Screen
          name="MontrealSingleGameplay"
          component={MontrealSingleGameplay}
        />
      </Stack.Navigator>
    );
  };
  ...
  ///////// Loader
  const [startMontrealStarLoader, setStartMontrealStarLoader] = useState(false);
